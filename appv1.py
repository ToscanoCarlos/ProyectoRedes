...
class Interface(db.Model):
    ...
    def __init__(self, router_id, tipo, numero, ip, mascara, estado, router_conectado):
        ...
        self.estado = estado
        self.router_conectado = router_conectado
...
def add_usuario():
    if request.method == 'POST':
        ...
        new_usuario = Usuario(nombre, permisos, dispositivos)
